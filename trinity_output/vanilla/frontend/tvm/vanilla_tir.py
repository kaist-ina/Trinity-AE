...
class Module:
    ...
    def main(x: R.Tensor((16, 4096), dtype="float32")) -> R.Tuple(R.Tensor((32, 1024, 128), dtype="float32"), R.Tensor((32, 1024, 128), dtype="float32"), R.Tensor((16, 4096), dtype="float32")):
        ...
        with R.dataflow():
            ...
            lv31 = R.call_tir(cls.transpose2, (lv30,), out_sinfo=R.Tensor((16, 32, 128), dtype="float32"))
            lv32 = R.call_tir(cls.reshape1, (lv31,), out_sinfo=R.Tensor((16, 4096), dtype="float32"))
            gv: R.Tuple(R.Tensor((32, 1024, 128), dtype="float32"), R.Tensor((32, 1024, 128), dtype="float32"), R.Tensor((16, 4096), dtype="float32")) = lv14, lv20, lv32
            R.output(gv)
        return gv
