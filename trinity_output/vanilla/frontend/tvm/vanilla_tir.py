...
class Module:
    ...
    @T.prim_func(private=True)
    def broadcast_to1(lv25: T.Buffer((T.int64(32), T.int64(128), T.int64(1024)), "float32"), T_broadcast_to: T.Buffer((T.int64(32), T.int64(128), T.int64(1024)), "float32")):
        T.func_attr({"tirx.noalias": True})
        # with T.sblock("root"):
    ...
    @T.prim_func(private=True)
    def broadcast_to2(lv28: T.Buffer((T.int64(32), T.int64(16), T.int64(1024)), "float32"), T_broadcast_to: T.Buffer((T.int64(32), T.int64(16), T.int64(1024)), "float32")):
        T.func_attr({"tirx.noalias": True})
        # with T.sblock("root"):
        for ax0, ax1, ax2 in T.grid(T.int64(32), T.int64(16), T.int64(1024)):
            with T.sblock("T_broadcast_to"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(lv28[v_ax0, v_ax1, v_ax2])
                T.writes(T_broadcast_to[v_ax0, v_ax1, v_ax2])
                T_broadcast_to[v_ax0, v_ax1, v_ax2] = lv28[v_ax0, v_ax1, v_ax2]

    @T.prim_func(private=True)
    def broadcast_to3(lv22: T.Buffer((T.int64(32), T.int64(1024), T.int64(128)), "float32"), T_broadcast_to: T.Buffer((T.int64(32), T.int64(1024), T.int64(128)), "float32")):
        T.func_attr({"tirx.noalias": True})
        # with T.sblock("root"):
    ...
    @T.prim_func(private=True)
    def matmul1(lv24: T.Buffer((T.int64(32), T.int64(16), T.int64(128)), "float32"), lv26: T.Buffer((T.int64(32), T.int64(128), T.int64(1024)), "float32"), matmul: T.Buffer((T.int64(32), T.int64(16), T.int64(1024)), "float32")):
        T.func_attr({"tirx.noalias": True})
        # with T.sblock("root"):
    ...
    @T.prim_func(private=True)
    def slice_scatter(lv13: T.Buffer((T.int64(32), T.int64(16), T.int64(128)), "float32"), lv12: T.Buffer((T.int64(32), T.int64(16), T.int64(128)), "float32"), compute: T.Buffer((T.int64(32), T.int64(16), T.int64(128)), "float32")):
        T.func_attr({"tirx.noalias": True})
        # with T.sblock("root"):
        for i0, i1, i2 in T.grid(T.int64(32), T.int64(16), T.int64(128)):
            with T.sblock("compute"):
                v_i0, v_i1, v_i2 = T.axis.remap("SSS", [i0, i1, i2])
                T.reads(lv12[v_i0, v_i1, v_i2])
                T.writes(compute[v_i0, v_i1, v_i2])
                compute[v_i0, v_i1, v_i2] = lv12[v_i0, v_i1, v_i2]

    @T.prim_func(private=True)
    def slice_scatter1(A: T.Buffer((T.int64(32), T.int64(1024), T.int64(128)), "float32"), lv14: T.Buffer((T.int64(32), T.int64(16), T.int64(128)), "float32"), T_where: T.Buffer((T.int64(32), T.int64(1024), T.int64(128)), "float32")):
        T.func_attr({"tirx.noalias": True})
        # with T.sblock("root"):
        ...
        for ax0, ax1, ax2 in T.grid(T.int64(32), T.int64(1024), T.int64(128)):
            with T.sblock("T_take"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(lv14[v_ax0, compute[v_ax1], v_ax2], compute[v_ax1])
                T.writes(T_take[v_ax0, v_ax1, v_ax2])
                T_take[v_ax0, v_ax1, v_ax2] = lv14[v_ax0, compute[v_ax1], v_ax2]
        for ax0, ax1, ax2 in T.grid(T.int64(32), T.int64(1024), T.int64(128)):
    ...
    @T.prim_func(private=True)
    def slice_scatter2(A: T.Buffer((T.int64(32), T.int64(1024), T.int64(128)), "float32"), lv15: T.Buffer((T.int64(32), T.int64(1024), T.int64(128)), "float32"), compute: T.Buffer((T.int64(32), T.int64(1024), T.int64(128)), "float32")):
        T.func_attr({"tirx.noalias": True})
        # with T.sblock("root"):
    ...
    @T.prim_func(private=True)
    def softmax(lv27: T.Buffer((T.int64(32), T.int64(16), T.int64(1024)), "float32"), T_softmax_norm: T.Buffer((T.int64(32), T.int64(16), T.int64(1024)), "float32")):
        T.func_attr({"tirx.noalias": True})
        # with T.sblock("root"):
        T_softmax_maxelem = T.sblock_alloc_buffer((T.int64(32), T.int64(16)))
        T_softmax_exp = T.sblock_alloc_buffer((T.int64(32), T.int64(16), T.int64(1024)))
        T_softmax_expsum = T.sblock_alloc_buffer((T.int64(32), T.int64(16)))
        for i0, i1, k in T.grid(T.int64(32), T.int64(16), T.int64(1024)):
            with T.sblock("T_softmax_maxelem"):
                v_i0, v_i1, v_k = T.axis.remap("SSR", [i0, i1, k])
                T.reads(lv27[v_i0, v_i1, v_k])
                T.writes(T_softmax_maxelem[v_i0, v_i1])
                with T.init():
                    T_softmax_maxelem[v_i0, v_i1] = T.float32(-340282346638528859811704183484516925440.0)
                T_softmax_maxelem[v_i0, v_i1] = T.max(T_softmax_maxelem[v_i0, v_i1], lv27[v_i0, v_i1, v_k])
        for i0, i1, i2 in T.grid(T.int64(32), T.int64(16), T.int64(1024)):
            with T.sblock("T_softmax_exp"):
                v_i0, v_i1, v_i2 = T.axis.remap("SSS", [i0, i1, i2])
                T.reads(lv27[v_i0, v_i1, v_i2], T_softmax_maxelem[v_i0, v_i1])
                T.writes(T_softmax_exp[v_i0, v_i1, v_i2])
                T_softmax_exp[v_i0, v_i1, v_i2] = T.exp(lv27[v_i0, v_i1, v_i2] - T_softmax_maxelem[v_i0, v_i1])
        for i0, i1, k in T.grid(T.int64(32), T.int64(16), T.int64(1024)):
    ...
    @T.prim_func(private=True)
    def transpose2(lv16: T.Buffer((T.int64(32), T.int64(1024), T.int64(128)), "float32"), T_transpose: T.Buffer((T.int64(32), T.int64(128), T.int64(1024)), "float32")):
        T.func_attr({"tirx.noalias": True})
        # with T.sblock("root"):
        for ax0, ax1, ax2 in T.grid(T.int64(32), T.int64(128), T.int64(1024)):
            with T.sblock("T_transpose"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(lv16[v_ax0, v_ax2, v_ax1])
                T.writes(T_transpose[v_ax0, v_ax1, v_ax2])
                T_transpose[v_ax0, v_ax1, v_ax2] = lv16[v_ax0, v_ax2, v_ax1]
    ...
    def main(x: R.Tensor((16, 4096), dtype="float32"), p_q_proj_weight: R.Tensor((4096, 4096), dtype="float32"), p_k_proj_weight: R.Tensor((4096, 4096), dtype="float32"), p_v_proj_weight: R.Tensor((4096, 4096), dtype="float32")) -> R.Tuple(R.Tensor((32, 1024, 128), dtype="float32"), R.Tensor((32, 1024, 128), dtype="float32"), R.Tensor((16, 4096), dtype="float32")):
        ...
        with R.dataflow():
            ...
            lv11 = R.call_tir(cls.strided_slice, (metadata["relax.expr.Constant"][0],), out_sinfo=R.Tensor((32, 16, 128), dtype="float32"))
            lv12 = R.call_tir(cls.broadcast_to, (lv9,), out_sinfo=R.Tensor((32, 16, 128), dtype="float32"))
            lv13 = R.call_tir(cls.strided_slice, (metadata["relax.expr.Constant"][0],), out_sinfo=R.Tensor((32, 16, 128), dtype="float32"))
            lv14 = R.call_tir(cls.slice_scatter, (lv13, lv12), out_sinfo=R.Tensor((32, 16, 128), dtype="float32"))
            lv15 = R.call_tir(cls.slice_scatter1, (metadata["relax.expr.Constant"][0], lv14), out_sinfo=R.Tensor((32, 1024, 128), dtype="float32"))
            lv16 = R.call_tir(cls.slice_scatter2, (metadata["relax.expr.Constant"][0], lv15), out_sinfo=R.Tensor((32, 1024, 128), dtype="float32"))
            lv17 = R.call_tir(cls.strided_slice, (metadata["relax.expr.Constant"][1],), out_sinfo=R.Tensor((32, 16, 128), dtype="float32"))
            lv18 = R.call_tir(cls.broadcast_to, (lv10,), out_sinfo=R.Tensor((32, 16, 128), dtype="float32"))
            lv19 = R.call_tir(cls.strided_slice, (metadata["relax.expr.Constant"][1],), out_sinfo=R.Tensor((32, 16, 128), dtype="float32"))
            lv20 = R.call_tir(cls.slice_scatter, (lv19, lv18), out_sinfo=R.Tensor((32, 16, 128), dtype="float32"))
            lv21 = R.call_tir(cls.slice_scatter1, (metadata["relax.expr.Constant"][1], lv20), out_sinfo=R.Tensor((32, 1024, 128), dtype="float32"))
            lv22 = R.call_tir(cls.slice_scatter2, (metadata["relax.expr.Constant"][1], lv21), out_sinfo=R.Tensor((32, 1024, 128), dtype="float32"))
            lv23 = R.call_tir(cls.transpose1, (lv6,), out_sinfo=R.Tensor((32, 16, 128), dtype="float32"))
            lv24 = R.call_tir(cls.broadcast_to, (lv23,), out_sinfo=R.Tensor((32, 16, 128), dtype="float32"))
            lv25 = R.call_tir(cls.transpose2, (lv16,), out_sinfo=R.Tensor((32, 128, 1024), dtype="float32"))
            lv26 = R.call_tir(cls.broadcast_to1, (lv25,), out_sinfo=R.Tensor((32, 128, 1024), dtype="float32"))
            lv27 = R.call_tir(cls.matmul1, (lv24, lv26), out_sinfo=R.Tensor((32, 16, 1024), dtype="float32"))
            lv28 = R.call_tir(cls.softmax, (lv27,), out_sinfo=R.Tensor((32, 16, 1024), dtype="float32"))
            lv29 = R.call_tir(cls.broadcast_to2, (lv28,), out_sinfo=R.Tensor((32, 16, 1024), dtype="float32"))
            lv30 = R.call_tir(cls.broadcast_to3, (lv22,), out_sinfo=R.Tensor((32, 1024, 128), dtype="float32"))
            ...
            gv: R.Tuple(R.Tensor((32, 1024, 128), dtype="float32"), R.Tensor((32, 1024, 128), dtype="float32"), R.Tensor((16, 4096), dtype="float32")) = lv16, lv22, lv33
            R.output(gv)
        return gv
